        ...
        return `
            <div class="invoice-item" data-invoice="${inv.invoice_number}">
                ...
                <div class="invoice-actions">
                    <a href="/api/view/${currentBatchId}/${inv.filename}" target="_blank" class="btn btn-outline btn-sm" title="Visualiser">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                            <circle cx="12" cy="12" r="3"></circle>
                        </svg>
                    </a>
                    <a href="/api/download/${currentBatchId}/${inv.filename}" class="btn btn-secondary btn-sm" title="Télécharger">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
